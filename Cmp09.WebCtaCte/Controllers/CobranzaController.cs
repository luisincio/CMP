    ...
    public class CobranzaController : Controller
    {
        ...
        public ActionResult Procesar_Pago_Local(string vIds)
        {
            ...
            if (vId_Comprobante == 0)
            {
                ...
                return RedirectToAction("Comprobante", "Comprobante", new { vComprobante = vComprobante });
            }
            else
            {
                return RedirectToAction("Comprobante", "Comprobante", new { vComprobante = vId_Comprobante });
            }
        }
        #endregion
